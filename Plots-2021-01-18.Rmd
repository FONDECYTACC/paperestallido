...
```{r original_plots, fig.height = 14, fig.width = 23, echo=T, dpi= 320, cache= T, paged.print=TRUE, warning=F, eval=T, fig.align='center', fig.cap= "Appendix Figure 1. Trends of emergency department consultations and hospitalizations (2015-2019)"}
library(cowplot)
...
plot(impact3d_hosp_trauma, "original")$data %>% 
  ...
  theme_sjplot()+
  scale_x_date(date_breaks = "6 months",date_labels="%b %y",limits=c(as.Date("2015-01-05"),as.Date("2019-12-23")))+
  ylim(c(0,125))+
  #2021-05-11
...
plot(impact3d_ratio_resp, "original")$data %>%
  ...
  geom_ribbon(aes(ymin=lower,ymax=upper),fill="steelblue", alpha = 0.35)+
  theme_sjplot()+
  scale_x_date(date_breaks = "6 months",date_labels="%b %y",limits=c(as.Date("2015-01-05"),as.Date("2019-12-31")))+
  ylim(c(0,400))+
  #2021-05-11
  geom_vline(xintercept = as.numeric(as.Date("2019-10-18")), col = "gray50", lty = 2, size=1)+
      theme(axis.text.x = element_text(angle = angle_x, vjust = 0.5, hjust=.5,size=height_x),
...
cairo_ps("_figs/_FigS1_final.ps", 
           height = 14, width = 23,
           fallback_resolution = 600,
           family= "Times")
           #horizontal=T,
...
cairo_pdf("_figs/_FigS1_final.pdf", 
           height = 14, width = 23,
           fallback_resolution = 600,
           family= "Times")
           #horizontal=T,
...
```{r pointwise_plots, echo=T, fig.height = 14, fig.width = 23, dpi= 320, cache= T, paged.print=TRUE, warning=F, eval=T, fig.align='center', fig.cap= "Figure 1. Weekly differences between predicted and observed outcomes in the 10 weeks pre and post-exposure periods"}
...
cairo_pdf("_figs/_Fig1_final.pdf", 
           height = 14, width = 23,
           fallback_resolution = 600,
           family= "Times")
           #horizontal=T,
...
```{r cumulative_plots, echo=T, fig.height = 14, fig.width = 23, dpi= 320, cache= T, paged.print=TRUE, warning=F, eval=T, fig.align='center', fig.cap= "Figure 3. Cumulative difference between predicted and observed outcomes in the 10 weeks pre and post-exposure period"}
...
cairo_pdf("_figs/_Fig2_final.pdf", 
           height = 14, width = 23,
           fallback_resolution = 600,
           family= "Times")
           #horizontal=T,
...
```{r original_plots_esp, fig.height = 14, fig.width = 23, echo=T, dpi= 320, cache= T, paged.print=TRUE, warning=F, eval=T, fig.align='center', fig.cap= "Figura Suplementaria 1. Tendencias de consultas y hospitalizaciones por emergencias (2015-2019)"}
library(cowplot)
...
```{r pointwise_plots_esp, echo=T, fig.height = 14, fig.width = 23, dpi= 320, cache= T, paged.print=TRUE, warning=F, eval=T, fig.align='center', fig.cap= "Figura 1. Diferencias semanales entre resultados predichos y observados en las 10 semanas anteriores y posteriores a la exposición"}
...
```{r cumulative_plots_esp, echo=T, fig.height = 14, fig.width = 23, dpi= 320, cache= T, paged.print=TRUE, warning=F, eval=T, fig.align='center', fig.cap= "Figura 2. Diferencias acumuladas entre resultados predichos y observados, en las 10 semanas anteriores y posteriores a la exposición"}
...
```{r BSTS_table, messages=T, eval=F, warnings=T}
