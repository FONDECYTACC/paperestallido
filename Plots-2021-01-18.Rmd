...
plot(impact3d_hosp_trauma, "original")$data %>% 
  ...
  ylim(c(0,125))+
  geom_vline(xintercept = length(data15a64_rn$did[data15a64_rn$did==0])+1, col = "gray50", lty = 2, size=1)+
...
plot_grid(
  ...
  rate_trauma_plot3_red+scale_y_continuous(breaks=seq(-100,1250,250), limits = c(-100,1250)),
  rate_resp_plot3_red+scale_y_continuous(breaks=seq(-100,1250,250), limits = c(-100,1250)),
  #get_legend(t14_trend_leg + theme(legend.position="right",
  #                                 legend.text = element_text(size = 15))),
...
ggdraw(plot3b_red)+
  ...
  jpeg("_Fig2_final.jpg", height = 14, width = 23, units = 'in', res = 600)
  ggdraw(plot3b_red)+
     theme(plot.background = element_rect(fill=NA, color = NA))
  dev.off()
